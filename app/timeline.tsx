...
const timelineItems = [
  {
    ...
    description: "ศึกษาคณะ IT พร้อมทำโปรเจกต์จริงในมหาวิทยาลัย",
    icon: "🎓",
    type: "education",
  },
  {
    ...
    description: "ฝึกงานด้านการพัฒนาระบบจริงในองค์กร",
    icon: "💼",
    type: "experience",
  },
  {
    ...
    description: "เริ่มทำงานจริง พัฒนาเว็บไซต์และแอปพลิเคชัน",
    icon: "💻",
    type: "experience",
  },
];
