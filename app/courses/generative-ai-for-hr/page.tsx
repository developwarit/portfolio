          ...
          >
            ...
            <div className="rounded-xl bg-purple-50 p-6 mb-8">
              <p className="text-lg text-gray-800 leading-relaxed">
                💼 แปลง AI ให้เป็นผู้ช่วยอัจฉริยะของแผนก HR — ให้ AI ช่วยคัดกรองผู้สมัคร จดบันทึก สร้างประกาศรับสมัคร และจัดการงานประจำวันของ HR
              </p>
            </div>

            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p>
                คอร์สนี้ออกแบบมาเฉพาะสำหรับสายงาน HR ที่ต้องการใช้ AI ให้เกิดประโยชน์สูงสุด 🚀
              </p>
              <p>
                คุณจะได้เรียนรู้วิธีใช้ Generative AI ในการ:
              </p>
              <ul className="space-y-3 ml-6">
                <li className="flex items-start gap-3">
                  <span className="text-purple-500 mt-1">✅</span>
                  <span>คัดกรองผู้สมัครและสรุปเรซูเม่</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-500 mt-1">✅</span>
                  <span>เขียนประกาศรับสมัครงานที่ดึงดูด</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-500 mt-1">✅</span>
                  <span>จดบันทึกการสัมภาษณ์และวิเคราะห์ผล</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-500 mt-1">✅</span>
                  <span>สร้างรายงานและวิเคราะห์ข้อมูลพนักงาน</span>
                </li>
              </ul>
              <p>
                ไม่ต้องมีพื้นฐานการเขียนโค้ด — เพียงแค่รู้จัก AI ก็สามารถเริ่มต้นได้ทันที ✨
              </p>
            </div>
