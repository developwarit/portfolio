...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#faf9f7] text-gray-900">
      ...
      {/* Hero Section */}
      <section id="top" className="pt-28 pb-16 sm:pt-32 lg:pt-36">
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid gap-16 lg:grid-cols-[1fr_1.1fr] lg:items-center">
            {/* Left: Profile Photo */}
            <div className="flex-1 flex justify-center lg:justify-end">
              <div className="relative">
                <div className="h-72 w-72 overflow-hidden rounded-full border-4 border-gray-200 bg-gray-100 shadow-lg sm:h-80 sm:w-80 lg:h-96 lg:w-96">
                  <Image
      ...
      {/* About Section */}
      <MotionSection id="about" className="border-t border-gray-200">
      ...
      {/* Experience Section */}
      <MotionSection id="experience" className="border-t border-gray-200">
        <div className="mx-auto max-w-6xl px-6 py-20">
          <div className="mb-12">
      ...
      {/* Projects Section */}
      <MotionSection id="work" className="border-t border-gray-200 bg-white">
        <div className="mx-auto max-w-6xl px-6 py-20">
      ...
      {/* Tech Stack Section */}
      <MotionSection id="stack" className="border-t border-gray-200">
        <div className="mx-auto max-w-6xl px-6 py-20">
          <div className="mb-12">
      ...
      {/* Contact Section */}
      <MotionSection id="contact" className="border-t border-gray-200 bg-white">
        <div className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="mx-auto max-w-6xl px-6 py-12">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <div>
              ...
              <p className="text-sm text-gray-500">สร้างด้วย Next.js &amp; Tailwind CSS</p>
            </div>
            <div className="flex gap-4">
              <a href="https://github.com/developwarit" target="_blank" rel="noreferrer" className="text-gray-400 transition hover:text-gray-900">GitHub</a>
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="text-gray-400 transition hover:text-gray-900">LinkedIn</a>
            </div>
          </div>
          <p className="mt-6 text-center text-xs text-gray-400">ออกแบบและพัฒนาโดย วริทธิ์</p>
        </div>
      </footer>
    </main>
  );
